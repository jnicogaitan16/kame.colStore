...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('GENERIC', 'Genérico'), ('SIZE', 'Talla'), ('DIMENSION', 'Medida'), ('MUG_TYPE', 'Tipo de mug')], default='SIZE', max_length=20)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('product', 'kind', 'value'), name='uniq_product_variant_kind_value'),
        ),
    ]
