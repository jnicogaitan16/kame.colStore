 ...
 * ----------------------------------
 * Combinaciones reutilizables de clases Tailwind para primitives UI.
 * No sustituye globals.css: sistemas como drawer, pdp, loaders, card-premium
 * siguen definidos allí. Aquí solo registros de utilidad para panels,
 * formularios y botones inline.
 */
