...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header + date range: móvil fila completa; desktop bloque alineado a la derecha con anchos fijos */}
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <h1 className="text-lg font-semibold text-zinc-900 shrink-0">Dashboard</h1>
