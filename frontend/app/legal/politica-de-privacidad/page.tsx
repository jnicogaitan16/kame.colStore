  ...
  return (
    <section id={id} className="scroll-mt-28">
      <div className="flex items-end justify-between gap-4">
        <h2 className="type-section-title text-white/95">{title}</h2>
      </div>
      ...
      <div className="mt-6 max-w-none space-y-4">
        <div className="legal-richtext type-body text-white/78">{children}</div>
      </div>
    </section>
  );
}
    ...
    <div className="mx-auto max-w-5xl px-4 py-10 md:py-14">
      <div className="mb-10">
        <p className="type-ui-label text-neutral-500">
          <Link
            href="/"
            className="type-ui-label text-neutral-400 hover:text-white hover:underline"
          >
            Inicio
          </Link>
        ...
        <p className="type-body mt-3 max-w-2xl text-white/70">
          ...
          <strong className="text-white">Términos y condiciones</strong>,{" "}
          <strong className="text-white">Política de Privacidad</strong> y{" "}
          <strong className="text-white">Política de Cookies</strong>, junto con
      ...
      <div className="mb-12 rounded-2xl border border-white/10 bg-neutral-900/60 p-5 shadow-sm backdrop-blur">
        ...
        <p className="type-body mt-1 text-white/55">
      ...
      <div className="mt-14 rounded-2xl border border-white/10 bg-neutral-900/60 p-6 shadow-sm backdrop-blur">
        ...
        <p className="type-body mt-2 text-white/70">
          ...
          <a
            className="type-action text-emerald-300 hover:underline"
